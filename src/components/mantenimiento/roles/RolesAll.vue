      ...
      <table class="min-w-full">
        <thead>
          <tr class="border-t border-gray-100 dark:border-gray-800">
            ...
            <th class="py-3 text-left">
              <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Nombre del Rol</p>
            </th>
        ...
        <tbody>
          ...
          <tr v-else v-for="post in filteredusersarray" :key="post.id_usuario"
            ...
            <td class="py-3 whitespace-nowrap">
              <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ post.id_rol }}</p>
            </td>
            <td class="py-3 whitespace-nowrap">
              <div class="flex items-center gap-3">
            ...
            <td class="py-3 text-right whitespace-nowrap">
              <div class="flex justify-end gap-2">
                ...
                <button @click="eliminar(post.id_rol, post.nombre_rol)"
        ...
        <div
          ...
          <div class="px-2 pr-14">
            ...
            <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
              Llene todos los campos para agregar un nuevo rol.
            </p>
          </div>
          <form class="flex flex-col">
            <div class="px-2 overflow-y-auto custom-scrollbar">
              ...
              <div>
                ...
                <textarea v-model="objetoguardar.descripcion" placeholder="Ingrese la descripción del Rol..." rows="6"
      ...
      <template #body>
        <div
          ...
          <div class="px-2 pr-14">
            ...
            <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
              Los datos mostrados son los actuales del rol. Realice los cambios necesarios y guarde.
            </p>
          </div>
          <form class="flex flex-col">
            <div class="px-2 overflow-y-auto custom-scrollbar">
              ...
              <div>
                ...
                <textarea v-model="objetoeditar.descripcion" placeholder="Ingrese la descripción del Rol..." rows="6"
                  class="dark:bg-dark-900 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"></textarea>
              </div>
            </div>
            <div class="flex items-center gap-3 mt-6 lg:justify-end">
...
import Modal from '@/components/Modal/Modal.vue'
import { mostraralertas2, enviarsolig,eliminacion } from '@/assets/js/function/funciones';
  ...
  methods: {
    ...
    async registrar() {
      ...
      try {
        ...
        const exito = await enviarsolig('POST', params, `${this.baseUrl}/roles`, 'Rol registrado con éxito');
        if (exito) {
    ...
    async Update() {
      ...
      try {
        ...
        const exito = await enviarsolig('PUT', params, `${this.baseUrl}/roles/${this.objetoeditar.id_rol}`, 'Rol Editado con éxito');
        if (exito) {
    ...
    eliminar(id, nombre) {
      try {
        eliminacion(
          `${this.baseUrl}/eliminarrol/`,
          id,
          'Eliminar registro',
          '¿Realmente desea eliminar el rol  ' + nombre + '?',
