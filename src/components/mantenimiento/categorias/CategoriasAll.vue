      ...
      <div>
        ...
        <form class="flex-grow">
          <div class="relative">
            ...
            <input type="text" placeholder="Ingresa el nombre de la categoría a buscar..." v-model="searchQuery"
    ...
    <div class="max-w-full overflow-x-auto custom-scrollbar">
      <table class="min-w-full">
        ...
        <tbody>
          ...
          <tr v-else v-for="post in filteredobjetoarray" :key="post.id_categoria"
            class="border-t border-gray-100 dark:border-gray-800">
            <td class="py-3 whitespace-nowrap">
              <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ post.id_categoria }}</p>
            </td>
            <td class="py-3 whitespace-nowrap">
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span class="text-gray-500 text-theme-xs dark:text-gray-400">{{ post.descripcion }}</span>
                </div>
              </div>
            </td>
            ...
            <td class="py-3 text-right whitespace-nowrap">
              <div class="flex justify-end gap-2">
                ...
                <button @click="eliminar(post.id_categoria, post.nombre)" v-if="post.estado === 1"
                ...
                <button @click="habilitar(post.id_categoria, post.nombre)" v-if="post.estado === 0"
        ...
        <div
          ...
          <div class="px-2 pr-14">
            ...
            <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
              Llene todos los campos para agregar una nueva categoría.
            </p>
          </div>
      ...
      <template #body>
        <div
          ...
          <div class="px-2 pr-14">
            ...
            <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
              Los datos mostrados son los actuales de la categoría. Realice los cambios necesarios y guarde.
            </p>
          </div>
          <form class="flex flex-col">
            <div class="px-2 overflow-y-auto custom-scrollbar">
...
export default {
  ...
  computed: {
    ...
    formIsValid() {
      return (
        this.objetoguardar.nombre_rol !== '' &&
        this.objetoguardar.descripcion !== ''
      );
    },
    formIsValidEdit() {
      return (
        this.objetoeditar.nombre_rol !== '' &&
  ...
  methods: {
    ...
    async GetData(page = 1, searchQuery = "", selectedStatus = "") {
      ...
      try {
        ...
        const response = await API.get(`${this.baseUrl}/categorias`, { params });
    ...
    async registrar() {
      ...
      try {
        ...
        const exito = await enviarsolig('POST', params, `${this.baseUrl}/categorias`, 'Categoría registrada con éxito');
        if (exito) {
    ...
    async Update() {
      ...
      try {
        ...
        const exito = await enviarsolig('PUT', params, `${this.baseUrl}/categorias/${this.objetoeditar.id_categoria}`, 'Categoría Editada con éxito');
        if (exito) {
