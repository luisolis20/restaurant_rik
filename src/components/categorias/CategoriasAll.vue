        ...
        <thead>
          <tr class="border-t border-gray-100 dark:border-gray-800">
            <th class="py-3 text-left">
              <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Categoría - Descripción</p>
            </th>
            ...
            <td class="py-3 whitespace-nowrap">
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span class="text-gray-500 text-theme-xs dark:text-gray-400">Descripción {{ product.variants }}</span>
                </div>
              </div>
            </td>
